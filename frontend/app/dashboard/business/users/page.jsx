'use client';
/**
 * Staff moved into Staff and access (/dashboard/business/access), which replaced this page and
...
export default function MovedToAccess() {
  ...
  return (
    <div style={{ padding: 24, fontSize: 13, color: 'var(--gray)' }}>
      Staff is now part of <a href="/dashboard/business/access" style={{ color: 'var(--gold)', fontWeight: 700 }}>Staff and access</a>. Taking you there.
    </div>
  );
}
