...
function CustomOrderInner() {
  ...
  if (loading) {
    ...
    return (
      <div style={{ minHeight: '100vh', background: 'var(--black)', color: 'var(--white)', padding: '2rem 1rem 4rem', fontFamily: "'Figtree', sans-serif" }}>
  ...
  if (requestSubmitted) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--black)', padding: '20px', fontFamily: "'Figtree', sans-serif" }}>
  ...
  if (loadError || !product) return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', background: 'var(--black)', color: 'var(--white)', fontFamily: "'Figtree', sans-serif" }}>
        ...
        <div onClick={() => setPendingMode(null)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 9998, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
          <div onClick={e => e.stopPropagation()} style={{ background: 'var(--dark2)', border: '1px solid var(--border)', borderRadius: '14px', maxWidth: '380px', width: '100%', padding: '22px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button onClick={() => setPendingMode(null)} style={{ flex: 1, padding: '10px', borderRadius: '8px', border: '1px solid var(--border)', background: 'transparent', color: 'var(--gray)', fontSize: '0.85rem', cursor: 'pointer', fontFamily: "'Figtree', sans-serif" }}>Cancel</button>
              <button onClick={() => { const m = pendingMode; setPendingMode(null); applyMode(m); }} style={{ flex: 1, padding: '10px', borderRadius: '8px', border: 'none', background: 'var(--gold)', color: '#000', fontSize: '0.85rem', fontWeight: 700, cursor: 'pointer', fontFamily: "'Figtree', sans-serif" }}>Switch</button>
            </div>
          </div>
        </div>
      )}
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <input type="text" inputMode="numeric" pattern="[0-9]*" value={quantityInput}
                    ...
                    style={{ width: 64, textAlign: 'center', padding: '0.4rem', borderRadius: '8px', border: '1px solid var(--border)', background: 'rgba(255,255,255,0.05)', color: 'var(--white)', fontSize: '0.95rem', fontFamily: "'Figtree', sans-serif" }} />
                  <button
                ...
                <div style={{ marginTop: '0.85rem' }}>
                  ...
                  {printIntent === 'notes' && (
                    <textarea value={designNotes} maxLength={2000} onChange={e => setDesignNotes(e.target.value)}
                      ...
                      rows={3}
                      style={{ width: '100%', padding: '0.75rem', borderRadius: '8px', border: '1px solid var(--border)', background: 'rgba(255,255,255,0.05)', color: 'var(--white)', fontSize: '0.85rem', fontFamily: "'Figtree', sans-serif", resize: 'vertical', boxSizing: 'border-box', outline: 'none' }} />
                  )}
                </div>
              )}
              ...
              {canOrder && !addedToCart && (
                <button onClick={handleAddToCart} disabled={placing || addingToCart || !agreedTerms}
                  style={{ width: '100%', padding: '0.9rem', background: addingToCart ? 'rgba(212,168,67,0.55)' : 'var(--gold)',
                    ...
                    cursor: (addingToCart ? 'wait' : (!agreedTerms ? 'not-allowed' : 'pointer')), fontFamily: "'Figtree', sans-serif", opacity: !agreedTerms ? 0.5 : 1 }}>
              ...
              {canOrder && !addedToCart && (
                <button onClick={handleBuyNow} disabled={placing || addingToCart || !agreedTerms}
                  style={{ width: '100%', padding: '0.85rem', marginTop: '0.6rem', background: 'transparent',
                    ...
                    fontSize: '0.9rem', cursor: !agreedTerms ? 'not-allowed' : 'pointer', fontFamily: "'Figtree', sans-serif", opacity: !agreedTerms ? 0.5 : 1 }}>
                  Buy it now
                </button>
              )}
              ...
              {isInquiry && (
                <button onClick={handleSubmit} disabled={placing || !agreedTerms}
                  style={{ width: '100%', padding: isInquiry ? '0.9rem' : '0.75rem', marginTop: isInquiry ? 0 : '0.6rem',
                    ...
                    cursor: placing ? 'wait' : (!agreedTerms ? 'not-allowed' : 'pointer'), fontFamily: "'Figtree', sans-serif",
