...
export default function CartPage() {
  ...
  if (!isCartLoading && enrichedCart.length === 0) {
    return (
      <div className="shop-container" style={{ maxWidth: 900, margin: '0 auto', padding: '2.5rem 1rem', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif" }}>
