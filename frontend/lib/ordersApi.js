...
function normalizeOrder(apiOrder) {
  ...
  return {
    ...
    rushStatus:            apiOrder.rushStatus ?? null,
    needByDate:            apiOrder.needByDate ?? null,
    isRush:                !!apiOrder.isRush,
    ...
    agreedToTerms:         apiOrder.agreedToTerms ?? false,
    agreedAt:              apiOrder.agreedAt ?? null,
    termsVersion:          apiOrder.termsVersion ?? null,
