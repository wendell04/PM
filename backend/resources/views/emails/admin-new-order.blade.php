          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 24px;font-size:14px;color: #6b6b6b;line-height:1.7;">
                A customer has placed a new order on the website.
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:10px 16px;border-bottom:1px solid rgba(255,255,255,0.05);
                             font-size:11px;color: #6b6b6b;width:30%;text-transform:uppercase;letter-spacing:0.5px;">
                    Name
                  </td>
                  <td style="padding:10px 16px;border-bottom:1px solid rgba(255,255,255,0.05);
                ...
                <tr>
                  <td style="padding:10px 16px;border-bottom:1px solid rgba(255,255,255,0.05);
                             font-size:11px;color: #6b6b6b;text-transform:uppercase;letter-spacing:0.5px;">
                    Email
                  </td>
                  <td style="padding:10px 16px;border-bottom:1px solid rgba(255,255,255,0.05);
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid rgba(255,255,255,0.06);text-align:center;">
              <p style="margin:0;font-size:11px;color: #444444;">
                &copy; {{ date('Y') }} Personalize Me Prints. This is an internal admin notification.
              </p>
            </td>
          </tr>
