    ...
    <body style="font-family: Arial, sans-serif; background: #f0efec; margin: 0; padding: 0;">
        <div class="wrapper" style="max-width: 480px; margin: 40px auto; background: #ffffff; border-radius: 16px; overflow: hidden;">
            ...
            <div class="body" style="padding: 36px 40px;">
                ...
                <p style="color: #444444; font-size: 14px; line-height: 1.7; margin: 0 0 16px;">You have been added to the Personalize Me Prints team as <strong style="color: #111111;">{{$roleLabel}}</strong>. Set your password to sign in to the dashboard.</p>
                <div style="text-align: center; margin: 24px 0;">
                    <a href="{{$inviteUrl}}" class="button" style="display: inline-block; background: #D4A843; color: #0f0f0f; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 700; font-size: 14px; margin: 16px 0; text-align:center;">Set my password</a>
                </div>
                <p style="color: #444444; font-size: 14px; line-height: 1.7; margin: 0 0 16px;">If you were not expecting this, you can ignore this email - nobody can sign in as you without setting the password here.</p>
                <p style="color: #444444; font-size: 14px; line-height: 1.7; margin: 0;"><strong style="color: #111111;">This link expires in 3 days.</strong> After that, ask the shop owner to send a new one.</p>
            </div>
