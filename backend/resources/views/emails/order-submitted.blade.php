    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        <table role="presentation" width="580" cellpadding="0" cellspacing="0"
          style="max-width:580px;background-color:#1a1a1a;border-radius:12px;
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:16px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:5px 0;font-size:12px;color:#555;width:40%;
                      ...
                      <tr>
                        ...
                        <td align="right" style="padding:5px 0;font-size:15px;color:#d4a843;
                                                  font-weight:700;">
                      ...
                      <tr>
                        ...
                        <td align="right" style="padding:5px 0;">
                          <span style="display:inline-block;background:rgba(212,168,67,0.12);
                                       ...
                                       padding:3px 10px;font-size:11px;color:#d4a843;
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid rgba(255,255,255,0.06);text-align:center;">
              <p style="margin:0 0 4px;font-size:11px;color:#444;">
