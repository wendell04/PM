    ...
    <body style="font-family: Arial, sans-serif; background: #f5f5f5; margin: 0; padding: 0;">
        <div class="wrapper" style="max-width: 480px; margin: 40px auto; background: #1a1a1a; border-radius: 16px; overflow: hidden;">
            ...
            <div class="body" style="padding: 36px 40px;">
                ...
                <p style="color: #aaa; font-size: 14px; line-height: 1.7; margin: 0 0 16px;">We received a request to reset your password. Use the code below to proceed:</p>
                ...
                <p style="color: #aaa; font-size: 14px; line-height: 1.7; margin: 0;">If you did not request a password reset, you can safely ignore this email.</p>
            </div>
