    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'subtext'             => 'nullable|string|max:2000',
                'ctaLabel'            => 'nullable|string|max:160',
                'ctaLink'             => 'nullable|string|max:2048',
                'cta2Label'           => 'nullable|string|max:160',
                'cta2Link'            => 'nullable|string|max:2048',
                ...
                'durationSeconds'     => 'nullable|integer|min:3|max:30',
